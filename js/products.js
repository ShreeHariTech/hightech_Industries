...
const PRODUCTS_DATA = [
  {
    ...
    specs: [
      { label: "Hydraulic Capacity", val: "150 Ton" },
    ...
    pills: ["150 Ton", "3HP Motorized", "Mild Steel"],
  ...
  },
  {
    ...
    specs: [
      { label: "Tonnage Rating", val: "100 - 150 Ton" },
      { label: "Body Build", val: "Mild Steel Frame" },
      { label: "Pressure Pack", val: "External Electric/Petrol Engine Pump" },
      { label: "Field Use", val: "Substation & Overhead Transmission" }
    ],
    pills: ["100T-150T", "Heavy Frame", "Power Transmission"],
  ...
  },
  {
    ...
    pills: ["8 Ton Capacity", "Mild Steel", "Height Adjustable"],
  ...
  },
  {
    ...
    pills: ["7 Ton", "Screw Mechanical", "Cable Laying"],
  ...
  },
  {
    id: "prod-05",
    index: "05",
    name: "Cable Pulling / Power Winch",
  ...
  },
  {
    ...
    specs: [
      { label: "Operating Force", val: "Up to 150 Ton" },
  ...
  if (products.length === 0) {
    container.innerHTML = `
      <div style="grid-column: 1 / -1; text-align: center; padding: 4rem 1rem; color: var(--color-text-secondary);">
        <h3 style="font-family: var(--font-heading); font-size: 1.5rem; margin-bottom: 0.5rem; color: var(--color-dark-blue);">NO PRODUCTS FOUND</h3>
        <p>Try resetting your search query or category filter selection.</p>
      </div>
    `;
    return;
  }
  ...
  container.innerHTML = products.map(prod => `
    <div class="product-card" data-id="${prod.id}">
      <div class="product-card-head">
        <span class="product-index">${prod.index}</span>
      ...
      <div class="product-card-body">
        ...
        <p style="font-size: 0.88rem; color: var(--color-text-secondary); line-height: 1.5; margin-bottom: 1rem;">${prod.description}</p>
